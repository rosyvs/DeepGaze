...
# Run this with -s slurm_multitask_GRU_comp_template.sh

#e.g.
# python scripts/run_slurm_multitask_GRU_comp.py \
# -s scripts/slurm_multitask_GRU_comp_template.sh \
# -f 0 1 2 3 --seed 21 \
# --encoder_dir lightning_logs/GRU_pretraining_seed21/ \
# --label_col Rote_X
